...
chapter: "Chapter 4"
period: "2022-2023"
summary: "Deploying DS-V2 components into Adobe Experience Manager so marketers and content creators could ship on-brand experiences without engineering bottlenecks."
...
<aside class="callout">
  ...
  <p>
    I led the integration of DS-V2 with Adobe Experience Manager, extending the
    front-end platform beyond engineering teams to enable marketers and
    content creators directly. The architecture, DS-V2 owns components,
    AEM consumes them as web components in templates, ensures one
    visual layer across applications, marketing, and content, and turned DS-V2
