---
order: 7
title: "AXS + AI: The Three-Layer Architecture"
chapter: "Technical Deep Dive"
period: "2024 — present"
summary: "How the AXS design system was extended into an AI-ready platform — IDE metadata at build time, an MCP server with 9 tools, and agentic workflows that enforce architecture from inside the IDE."
...
<div
  class="diagram"
  role="img"
  aria-label="Three-layer AXS AI architecture: Layer 1 generates IDE metadata at build time; Layer 2 exposes the design system through an MCP server with 9 tools; Layer 3 runs Claude Code skills that enforce architecture patterns for the AXS team itself."
>
  <div class="diagram-node is-stage">
    <div class="diagram-node-title">layer 1 &mdash; IDE metadata</div>
  ...
  <div class="diagram-node is-stage">
    <div class="diagram-node-title">layer 2 &mdash; MCP server</div>
    <div class="diagram-node-body">9 tools<br />any AI assistant becomes AXS-aware</div>
  </div>
  <div class="diagram-arrow">&#9660;<br /><span class="diagram-payload">feeds</span></div>
  <div class="diagram-node is-stage">
    <div class="diagram-node-title">layer 3 &mdash; Claude Code skills</div>
    <div class="diagram-node-body">agentic workflows<br />for the AXS team itself</div>
  </div>
</div>
