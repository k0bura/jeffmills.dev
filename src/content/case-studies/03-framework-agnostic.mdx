...
<div
  class="diagram"
  role="img"
  aria-label="AXS code-agnostic distribution. A single Vue single-file component source compiles to two exports: a standards-based custom element and per-framework adapters. The same artifacts ship to Vue apps, Angular apps, AEM templates, Storybook, and any HTML page via CDN."
>
  <div class="diagram-node is-stage">
    <div class="diagram-node-title">AXS component source</div>
