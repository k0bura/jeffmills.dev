...
chapter: "Chapter 3"
period: "2021-2023"
summary: "Designing Meridian as a framework-agnostic system so it could support Angular, Vue, and AEM simultaneously, and outlast whatever framework comes next."
...
<aside class="callout">
  ...
  <p>
    I helped architect Meridian as a framework-agnostic design system, enabling the
...
I played a key role in defining and reinforcing a framework-agnostic architecture inside Meridian. This was a strategic architectural decision more than a technical one, it shaped how teams *thought* about front-end systems, not just what they built. The goal was for Meridian to outlast any individual framework choice.

## What I did

**Designed Meridian as framework-agnostic.** Components are independent of application frameworks. The same component logic runs across Angular, Vue, and AEM through framework adapters and standards-based custom elements. The implementation is intentionally separated from the application's technical stack.

<div
  class="diagram"
  role="img"
  aria-label="Meridian code-agnostic distribution. A single Vue single-file component source compiles to two exports: a standards-based custom element and per-framework adapters. The same artifacts ship to Vue apps, Angular apps, AEM templates, Storybook, and any HTML page via CDN."
>
  <div class="diagram-node is-stage">
    <div class="diagram-node-title">Meridian component source</div>
    <div class="diagram-node-body">Vue single-file component</div>
  </div>
  <div class="diagram-arrow">&#9660;<br /><span class="diagram-payload">build pipeline</span></div>

  <div class="diagram-row-label">exports</div>
  <div class="diagram-row">
    <div class="diagram-node is-stage">
      <div class="diagram-node-title">custom element</div>
      <div class="diagram-node-body">standards-based<br />HTML / JS + global CSS</div>
    </div>
    <div class="diagram-node is-stage">
      <div class="diagram-node-title">framework adapters</div>
      <div class="diagram-node-body">Vue / Angular / AEM wrappers</div>
    </div>
  </div>
  ...
  <div class="diagram-row-label">consumers</div>
  <div class="diagram-row">
    <div class="diagram-node">Vue app</div>
    <div class="diagram-node">Angular app</div>
    <div class="diagram-node">AEM template</div>
    <div class="diagram-node">Storybook</div>
    <div class="diagram-node">any HTML / CDN</div>
  </div>

  <p class="diagram-note">
    One source. Two exports. Many consumers. Same component logic
    everywhere.
  </p>
</div>
...
The same instinct shows up again in Chapter 6: when generative UI became the new substrate, Meridian was already ready for it because the architecture had never been tied to one stack to begin with.
