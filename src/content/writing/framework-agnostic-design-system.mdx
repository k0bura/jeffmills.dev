...
When DS-V2 started, framework discourse looked like this: pick Vue *or* React *or* Angular and commit. Web components were "interesting but not ready." Cross-framework was either a tooling problem you solved with bundlers or a problem you didn't have because you only used one framework.
