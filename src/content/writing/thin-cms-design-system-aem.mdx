...
In our case the design system is DS-V2, the CMS is Adobe Experience Manager, and "consumes" means the components ship as standards-based custom elements that AEM templates declare directly.
...
**A clear ownership boundary.** DS-V2 owns the component. AEM owns the authoring experience and the slot content. Neither side touches the other's surface. Decisions about styling go to DS-V2; decisions about authoring ergonomics go to AEM. Mixing those produces fragmentation in under a quarter.
